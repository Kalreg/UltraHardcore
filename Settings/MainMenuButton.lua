...
local button = CreateFrame("Button", "GameMenuButtonUltraHardcore", EscapeMenu, "EscapeMenuButtonTemplate")
...
button:SetPoint("TOP", EscapeMenu, "TOP", 0, 0)
...
--[[ 
    ...
    EscapeMenu:HookScript("OnShow", function(self)
...
--[[ 
    ...
    button:SetPoint("TOP", EscapeMenu, "TOP", 0, -67)
